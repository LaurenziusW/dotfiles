...
# Create the stow targets so we don't symlink to non-existent parents
mkdir -p ~/dotfiles/uke-v8/{mac,arch,shared}
...
echo "  2. Clone your repo: git clone <url> ~/dotfiles/uke-v8"
echo "  3. Run: ~/dotfiles/uke-v8/install.sh"
echo "----------------------------------------------------------------"