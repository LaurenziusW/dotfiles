#!/usr/bin/env bash
# ==============================================================================
# UKE Config Generator v6.3.0 - Arch Linux Ready
# ==============================================================================
set -euo pipefail
...
gen_hyprland() {
    ...
    cat > "$out" << 'EOF'
# ==============================================================================
# HYPRLAND CONFIG - AUTO-GENERATED BY UKE v6.3
# ==============================================================================
# Unified Keyboard Environment for Linux
# 
# Modifier Hierarchy:
#   PRIMARY:    Alt         → Window Manager (focus, move, workspaces)
#   SECONDARY:  Super       → Terminal UI (WezTerm handles internally)
